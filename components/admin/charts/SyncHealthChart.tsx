...
import type { SyncDay } from "@/lib/admin/queries";
...
export function SyncHealthChart({ data }: { data: SyncDay[] }) {
  if (!data.length) {
    return <p className="py-8 text-center text-sm text-muted-foreground">Sin datos de sync</p>;
  }
