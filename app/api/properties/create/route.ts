...
export async function POST(request: Request) {
  try {
    ...
    if (draftId) {
      ...
      dispatchAlertNuevaPropiedad(resolvedUserId, propertyId, address, 'PUBLICADA');
...
function dispatchAlertNuevaPropiedad(userId: string, propertyId: number, address: string | undefined, status: string) {
  (async () => {
