    ...
    <>
      ...
      <FAQJsonLd
        items={[
          ...
          { question: "¿Cuánto cuesta usar Mob?", answer: "Para inquilinos, buscar y visitar propiedades es completamente gratis. Para propietarios, publicar es gratis y solo se cobra una comisión cuando el alquiler se concreta. No hay costos iniciales ni cargos ocultos." },
        ]}
      />
