...
const mockOperaciones: Record<string, Operacion> = {
  "op-001": {
    ...
    tenantVerification: {
      ...
      dni: "35.456.789",
      gender: "femenino",
      employmentSituation: "relacion_dependencia",
      jobTenureMonths: 28,
      monthlyIncome: 2800,
      incomeCurrency: "USD",
    },
  ...
  "op-002": {
    ...
    tenantVerification: {
      ...
      dni: "37.890.123",
      gender: "masculino",
      employmentSituation: "monotributista",
      jobTenureMonths: 42,
      monthlyIncome: 3500,
      incomeCurrency: "USD",
    },
  ...
  "op-003": {
    ...
    tenantVerification: {
      ...
      dni: "36.789.012",
      gender: "femenino",
      employmentSituation: "responsable_inscripto",
      jobTenureMonths: 60,
      monthlyIncome: 4200,
      incomeCurrency: "USD",
    },
  ...
  "op-004": {
    ...
    tenantVerification: {
      ...
      dni: "38.012.345",
      gender: "masculino",
      employmentSituation: "estudiante_universitario",
      jobTenureMonths: 18,
      monthlyIncome: 2500,
      incomeCurrency: "USD",
    },
